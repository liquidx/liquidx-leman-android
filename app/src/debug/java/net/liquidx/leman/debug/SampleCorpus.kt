...
object SampleCorpus {
    ...
    fun threads(now: Long): List<ThreadEntity> = listOf(
        ThreadEntity(
            ...
            sessionId = "run-geneva-1", agentName = null, agentGlyph = null,
        ),
        ThreadEntity(
            ...
            sessionId = "run-insurance-1", agentName = null, agentGlyph = null,
        ),
        ThreadEntity(
            ...
            sessionId = "run-digest-1", agentName = null, agentGlyph = null,
        ),
        ThreadEntity(
            ...
            sessionId = "run-ci-1", agentName = null, agentGlyph = null,
        ),
        ThreadEntity(
        ...
        ThreadEntity(
            ...
            sessionId = "run-board-1", agentName = null, agentGlyph = null,
        ),
        ThreadEntity(
            ...
            sessionId = "run-hn-1", agentName = null, agentGlyph = null,
        ),
    )
